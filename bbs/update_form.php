  ...
  <body>
    ...
    <div class="form-floating mb-3 col-sm-3">
      ...
      <div class="form-floating mb-3 col-sm-3">
        ...
        Content<textarea class="form-control" id="exampleFormControlTextarea1" name="content" rows="3"></textarea>
      </div>
      <div class="form-floating mb-3 col-sm-3">
        <label for="exampleFormControlInput1" class="form-label"></label>
        email<input type="email" class="form-control" id="exampleFormControlInput1" name= "email" placeholder="email" value="<?php echo $re[6] ?>">
      </div>
